 ...
 */
// forbiden 比如将图片放到一个文件夹上，出现这个标志，因为文件夹是只读的
...
@interface DragCollectionViewController () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDragDelegate, UICollectionViewDropDelegate>
...
- (void)setupCollectionView {
    ...
    [_collectionView registerClass:[ImageCollectionViewCell class] forCellWithReuseIdentifier:kImageCellIdentifier];
