...
@interface DragTableViewController () <UITableViewDelegate, UITableViewDataSource, UITableViewDragDelegate, UITableViewDropDelegate>
...
- (void)setupView {
    ...
    [_tableView registerClass:[ImageTableViewCell class] forCellReuseIdentifier:identifier];
