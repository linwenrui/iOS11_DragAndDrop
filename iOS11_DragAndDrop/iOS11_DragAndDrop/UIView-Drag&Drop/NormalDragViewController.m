...
#import "NormalDragViewController.h"

@interface NormalDragViewController () <UIDragInteractionDelegate, UIDropInteractionDelegate>

@property (nonatomic, strong) UIImageView *dragView;

@end

@implementation NormalDragViewController
...
- (void)setupUI {
    ...
    [self addDragAndDropInterraction:self.dragView];
    [self.view becomeFirstResponder];
    self.view.userInteractionEnabled = YES;
}

- (void)addDragAndDropInterraction:(UIImageView *)view {
...
- (void)loadImageWithItemProvider:(NSItemProvider *)itemProvider center:(CGPoint)center {
...
- (void)dropInteraction:(UIDropInteraction *)interaction performDrop:(id<UIDropSession>)session {
    ...
    if (session.localDragSession) {
        ...
        for (UIDragItem *item in session.items) {
            [self loadImageWithItemProvider:item.itemProvider center:dropPoint];
        }
    }
}
